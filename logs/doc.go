...
LoggerProvider from the github.com/hyperdxio/opentelemetry-logs-go package can be used as
a default.
...
*/
package logs // import "github.com/hyperdxio/opentelemetry-logs-go/logs"
