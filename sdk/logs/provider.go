...
package logs // Package logs import "github.com/hyperdxio/opentelemetry-logs-go/sdk/logs"

import (
	"context"
	"fmt"
	"github.com/hyperdxio/opentelemetry-logs-go/internal/global"
...
const (
	defaultLoggerName = "github.com/hyperdxio/opentelemetry-logs-go/sdk/logs/provider"
)
